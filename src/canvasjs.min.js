/*
 CanvasJS Chart - v3.7.23 GA - https://canvasjs.com/ 
...
borderThickness:this.borderThickness,backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:J,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"middle"});O=J.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(v=n.y1+2+this.fontSize/2+4,K="top"):"bottom"===this.verticalAlign&&(v=n.y2-2-O.height+this.fontSize/2+4,K="bottom"),"left"===this.horizontalAlign?w=n.x1+2:"center"===this.horizontalAlign?w=n.x1+n.width/
2-O.width/2:"right"===this.horizontalAlign&&(w=n.x2-2-O.width-A),G=this.horizontalAlign,this.width=O.width,this.height=O.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(w=n.x1+2+(this.fontSize/2+4),v=n.y2-2-(this.maxWidth/2-O.width/2),B=-90,K="left",this.width=O.height,this.height=O.width):"right"===this.horizontalAlign?(w=n.x2-2-(this.fontSize/2+4),v=n.y1+2+(this.maxWidth/2-O.width/2),B=90,K="right",this.width=O.height,this.height=O.width):"center"===this.horizontalAlign&&
(v=h.y1+(h.height/2-O.height/2)+this.fontSize/2+4,w=h.x1+(h.width/2-O.width/2),K="center",this.width=O.width,this.height=O.height),G="center");J.x=w;J.y=v;J.angle=B;J.horizontalAlign=G;this._textBlock=J;h.layoutManager.registerSpace(K,{width:this.width+("left"===K||"right"===K?this.margin+2:0),height:this.height+("top"===K||"bottom"===K?this.margin+2:0)});this.bounds={x1:w,y1:v,x2:w+this.width,y2:v+this.height};this.ctx.textBaseline="top"}};za.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};
...
180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360);this.options.scaleBreaks&&(this.scaleBreaks=new fa(this.chart,this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new O(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new ca(this.chart,
...
this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=n._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new Q(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=r(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=
...
1].y&&(a.axisY.logarithmic?(s=e/t.dataPoints[C-1].y,1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e-t.dataPoints[C-1].y,0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<C)){C-=2;continue}if(b>g&&!m)m=!0;else if(b>g&&m)continue;t.dataPoints[C].label&&(a.axisX.labels[b]=t.dataPoints[C].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&
(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}t.axisX.valueType=t.xValueType=f?"dateTime":"number"}};n.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],t=[],C=Infinity,k=-Infinity,m=0;m<a.dataSeriesIndexes.length;m++){var p=this.data[a.dataSeriesIndexes[m]],q=0,g=!1,s=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var ba=a.axisX.sessionVariables.newViewportMinimum?
...
p.xValueType)f=!0;for(q=0;q<p.dataPoints.length;q++){"undefined"===typeof p.dataPoints[q].x&&(p.dataPoints[q].x=q+(a.axisX.logarithmic?1:0));p.dataPoints[q].x.getTime?(f=!0,b=p.dataPoints[q].x.getTime()):b=p.dataPoints[q].x;e=r(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var y=b/p.dataPoints[q-1].x;1>y&&(y=1/y);c.minDiff>y&&1!==y&&(c.minDiff=y)}else y=b-p.dataPoints[q-1].x,0>y&&(y*=-1),c.minDiff>y&&0!==y&&(c.minDiff=y);null!==e&&null!==
p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(y=e/p.dataPoints[q-1].y,1>y&&(y=1/y),d.minDiff>y&&1!==y&&(d.minDiff=y)):(y=e-p.dataPoints[q-1].y,0>y&&(y*=-1),d.minDiff>y&&0!==y&&(d.minDiff=y)))}if(b<ba&&!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>u&&!s)s=!0;else if(b>u&&s)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=
...
function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,t=!1,C=[],k=0;k<a.dataSeriesIndexes.length;k++){var m=this.data[a.dataSeriesIndexes[k]],p=0,q=!1,g=!1,s;if("normal"===m.axisPlacement||"xySwapped"===m.axisPlacement)var h=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:a.axisX.options&&a.axisX.options.viewportMinimum?a.axisX.options.viewportMinimum:a.axisX.options&&a.axisX.options.minimum?
...
(f=!0,b=m.dataPoints[p].x.getTime()):b=m.dataPoints[p].x;e=r(m.dataPoints[p].y)?null:m.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var u=b/m.dataPoints[p-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-m.dataPoints[p-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);r(e)||null===m.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(u=e/m.dataPoints[p-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-m.dataPoints[p-1].y,0>u&&(u*=-1),d.minDiff>
u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(s=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>ba&&!g)g=!0;else if(b>ba&&g)continue;m.dataPoints[p].label&&(a.axisX.labels[b]=m.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&s<b&&(c.viewPortMin=s):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),C[b]=C[b]?C[b]+Math.abs(e):Math.abs(e))}}m.axisX.valueType=
...
-1),d.min=r(d.viewPortMin)?-99:Math.min(d.viewPortMin,-99));d.viewPortMin=d.min;d.viewPortMax=d.max;a.dataPointYSums=C}};n.prototype._processMultiYPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f,l,t=!1,C=0;C<a.dataSeriesIndexes.length;C++){var k=this.data[a.dataSeriesIndexes[C]],m=0,p=!1,q=!1,g,s,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var r=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:
...
for(m=0;m<k.dataPoints.length;m++){"undefined"===typeof k.dataPoints[m].x&&(k.dataPoints[m].x=m+(a.axisX.logarithmic?1:0));k.dataPoints[m].x.getTime?(t=!0,b=k.dataPoints[m].x.getTime()):b=k.dataPoints[m].x;if((e=k.dataPoints[m].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);s=!0;for(var y=0;y<e.length;y++)null===e.k&&(s=!1);s&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<m&&(a.axisX.logarithmic?(s=b/k.dataPoints[m-1].x,1>s&&(s=1/s),
c.minDiff>s&&1!==s&&(c.minDiff=s)):(s=b-k.dataPoints[m-1].x,0>s&&(s*=-1),c.minDiff>s&&0!==s&&(c.minDiff=s)),e&&(null!==e[0]&&k.dataPoints[m-1].y&&null!==k.dataPoints[m-1].y[0])&&(a.axisY.logarithmic?(s=e[0]/k.dataPoints[m-1].y[0],1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e[0]-k.dataPoints[m-1].y[0],0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s))));if(!(b<r)||p){if(!p&&(p=!0,0<m)){m-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[m].label&&(a.axisX.labels[b]=k.dataPoints[m].label);
...
b.type?d(b):0<=b.type.indexOf("stacked")&&c(b);for(l=0;l<this._axes.length;l++)if(this._axes[l].dataInfo._dataRanges){var C=this._axes[l].dataInfo.min;b=(this._axes[l].dataInfo.max+1-C)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[l].dataInfo._dataRanges,m,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;m=k;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(p=q[t],!r(p))){var g=Math.floor((p-
C)/b);p<m[g].min&&(m[g].min=p);p>m[g].max&&(m[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=this._axes[l].dataInfo.dataPointYNegativeSums;m=k;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(p=-1*q[t],r(p)||(g=Math.floor((p-C)/b),p<m[g].min&&(m[g].min=p),p>m[g].max&&(m[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(t=0;t<k.length-1;t++)if(m=k[t].max,isFinite(m))for(;t<k.length-1;)if(C=k[t+1].min,isFinite(C)){p=C-
...
source:"chart",index:this.stockChart.charts.indexOf(this),minimum:e.val1,maximum:e.val2});return a.isValid};n.prototype.validateRegion=function(a,d,c,b,e){e=e||!1;for(var f=0<=this.zoomType.indexOf("x"),l=0<=this.zoomType.indexOf("y"),t=!1,C=[],k=[],m=[],p=0;p<this._axes.length;p++)("axisX"===this._axes[p].type&&f||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var s=g,g=q,
q=s;if(p.scaleBreaks)for(s=0;!f&&s<p.scaleBreaks._appliedBreaks.length;s++)f=p.scaleBreaks._appliedBreaks[s].startValue<=q&&p.scaleBreaks._appliedBreaks[s].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(s=p.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&(p.logarithmic&&s<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&s<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))C.push(p),m.push({val1:q,val2:g}),t=!0;else if(!e){t=!1;
...
a.height=d.height;w||(a.canvas.width=a.width,a.canvas.height=a.height,a.canvas.style.left=a.x1+"px",a.canvas.style.top=a.y1+"px",(0<a.x1||0<a.y1)&&a.ctx.translate(-a.x1,-a.y1));a.layoutManager=new Fa(a.x1,a.y1,a.x2,a.y2,2)};n.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=f=e=0,t=0,C=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var m=this._indexLabels[a],p=m.chartType.toLowerCase(),q,g,l=ma("indexLabelFontColor",m.dataPoint,m.dataSeries),s=ma("indexLabelFontSize",
m.dataPoint,m.dataSeries),t=ma("indexLabelFontFamily",m.dataPoint,m.dataSeries),C=ma("indexLabelFontStyle",m.dataPoint,m.dataSeries),k=ma("indexLabelFontWeight",m.dataPoint,m.dataSeries),h=ma("indexLabelBackgroundColor",m.dataPoint,m.dataSeries);q=ma("indexLabelMaxWidth",m.dataPoint,m.dataSeries);g=ma("indexLabelWrap",m.dataPoint,m.dataSeries);var ba=ma("indexLabelLineDashType",m.dataPoint,m.dataSeries),u=ma("indexLabelLineColor",m.dataPoint,m.dataSeries),n=r(m.dataPoint.indexLabelLineThickness)?
...
("horizontal"===z?C/2:C/2-s/2);"inside"!==x?(e=c.y1,f=c.y2,0<v?(g=m.point.y+("horizontal"===z?s/2:0)-k-t-b,g<e&&(g="auto"===x?Math.max(m.point.y,e)+s/2+t:e+s/2+t,A=g+k>m.point.y)):(g=m.point.y+s/2+t+b,g>f-k&&(g="auto"===x?Math.min(m.point.y,f)+s/2-k-t:f+s/2-k,A=g<m.point.y))):(e=Math.max(m.bounds.y1,c.y1),f=Math.min(m.bounds.y2,c.y2-k+s/2),b=0<=p.indexOf("range")||"error"===p?0<v?Math.max(m.bounds.y1,c.y1)+s/2+t:Math.min(m.bounds.y2,c.y2)+s/2-k+t:(Math.max(m.bounds.y1,c.y1)+Math.min(m.bounds.y2,c.y2))/
2-k/2+s/2+("horizontal"===z?t:0),0<v?(g=Math.max(m.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(m.point.y-k-t,c.y1+t))):(g=Math.min(m.point.y,b),g>f-k-t&&("bubble"===p||"scatter"===p)&&(g=Math.min(m.point.y+t,c.y2-k-t))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||0<=p.indexOf("scatter")?(x="auto",l=4):0<=p.indexOf("stacked")?"auto"===x&&(x="inside"):"bubble"===p&&(x="inside"),g=m.point.y+s/2-k/2+t,"inside"!==x?(e=c.x1,f=c.x2,0>v?(q=m.point.x-("horizontal"===z?
C:C-s/2)-l-b,q<e&&(q="auto"===x?Math.max(m.point.x,e)+l:e+l,A=q+C>m.point.x)):(q=m.point.x+("horizontal"===z?0:s/2)+l+b,q>f-C-l-b&&(q="auto"===x?Math.min(m.point.x,f)-("horizontal"===z?C:C/2)-l:f-C-l,A=q<m.point.x))):(e=Math.max(m.bounds.x1,c.x1),Math.min(m.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===p?0>v?Math.max(m.bounds.x1,c.x1)+s/2+l:Math.min(m.bounds.x2,c.x2)-C/2-l+("horizontal"===z?0:s/2):(Math.max(m.bounds.x1,c.x1)+Math.min(m.bounds.x2,c.x2))/2+("horizontal"===z?0:s/2),q=0>v?Math.max(m.point.x,
b)-("horizontal"===z?C/2:0):Math.min(m.point.x,b)-C/2,q=Math.max(q,e));"vertical"===z&&(g+=k-s/2);h.x=q;h.y=g;h.render(!0);n&&("inside"!==x&&(0>p.indexOf("bar")&&("error"!==p||!m.axisSwapped)&&m.point.x>c.x1&&m.point.x<c.x2||!A)&&(0>p.indexOf("column")&&("error"!==p||m.axisSwapped)&&m.point.y>c.y1&&m.point.y<c.y2||!A))&&(d.lineWidth=n,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(J(ba,n)),d.beginPath(),d.moveTo(m.point.x,m.point.y),0<=p.indexOf("bar")||"error"===p&&m.axisSwapped?d.lineTo(q+
(0<m.direction?-l:C+l)+("vertical"===z?-s/2:0),g+("vertical"===z?-k/2:k/2-s/2)-t):0<=p.indexOf("column")||"error"===p&&!m.axisSwapped?d.lineTo(q+C/2-("horizontal"===z?0:s/2),g+("vertical"===z?(g-k<m.point.y?0:-k)+t:(g-s/2<m.point.y?k:0)-s/2)):0<=p.indexOf("waterfall")?d.lineTo(q+C/2-("horizontal"===z?0:s/2),"vertical"===z?0<v&&g<m.point.y?g:0>v&&g-k>m.point.y?g-k:m.point.y:0<v&&g+k-s/2<m.point.y?g+k-s/2:0>v&&g-s/2>m.point.y?g-s/2-2:m.point.y):d.lineTo(q+C/2-("horizontal"===z?0:s/2),g+("vertical"===
...
!0;else{n=a.axisX.convertValueToPixel(n);x=a.axisY.convertValueToPixel(m[u].y);var H=k.dataPointIds[u];this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:u,x1:n,y1:x};r||z?(!r&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(n,x),w&&b.lineTo(n,x)):(c.beginPath(),c.moveTo(n,x),w&&(b.beginPath(),
...
k.getMarkerProperties(u,n,x,c);f.push(D);H=X(H);w&&f.push({x:n,y:x,ctx:b,type:D.type,size:D.size,color:H,borderColor:H,borderThickness:D.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:n,y:x},direction:0>m[u].y===a.axisY.reversed?1:-1,color:s})}c.stroke();w&&b.stroke()}}W.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
...
u&&!(k.connectNullData||z||r)&&(c.stroke(),w&&b.stroke()),z=!0;else{var H=x;n=a.axisX.convertValueToPixel(n);x=a.axisY.convertValueToPixel(m[u].y);var D=k.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:u,x1:n,y1:x};r||z?(!r&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
...
this._eventManager.ghostCtx;b.save();var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var C=a.dataSeriesIndexes[t],k=this.data[C];b.lineWidth=k.lineThickness;var m=k.dataPoints,p="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);b.setLineDash(g)}var s=k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:C};s=X(s);e.strokeStyle=s;e.lineWidth=
...
1].newLineDashArray=q,p=k.nullDataLineDashType):(d(x),x=[])),n=!0;else{u=a.axisX.convertValueToPixel(u);n=a.axisY.convertValueToPixel(m[r].y);var z=k.dataPointIds[r];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:r,x1:u,y1:n};x[x.length]={x:u,y:n};r<m.length-1&&(h!==(m[r].lineColor||s)||p!==(m[r].lineDashType||k.lineDashType))&&(h=m[r].lineColor||s,x[x.length-1].newStrokeStyle=h,b.setLineDash&&(m[r].lineDashType?(p=m[r].lineDashType,x[x.length-1].newLineDashArray=
...
g=this.data[q],s=g.dataPoints;if(0<s.length)for(var h=5<p&&g.bevelEnabled?!0:!1,f=0;f<s.length;f++)if(s[f].getTime?C=s[f].x.getTime():C=s[f].x,!(C<a.axisX.dataInfo.viewPortMin||C>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[f].y){l=a.axisX.convertValueToPixel(C);t=a.axisY.convertValueToPixel(s[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var r=a.axisX.reversed?l-p<<0:l+p<<0,u;
...
!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);p=p-a.plotType.plotUnits.length*s/2+a.index*s<<0;var x=p+s<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(z=f[b]?f[b]:q,f[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)C[b]=u[k].y+(C[b]?C[b]:0),m=l[b]?l[b]:
q,l[b]=z=a.axisY.convertValueToPixel(C[b]);else if(m=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var H=f[b]?f[b]:0;z=q+H;m+=H;f[b]=H+(m-z)}else H=l[b]?l[b]:0,z=m-H,m=q-H,l[b]=H+(m-z);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];Y(c,a.axisY.reversed?m:z,p,a.axisY.reversed?z:m,x,b,0,null,n,!1,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:m,y2:x};b=X(b);w&&Y(this._eventManager.ghostCtx,
...
{objectType:"dataSeries",dataSeriesIndex:q};C=X(C);l.fillStyle=C;C=[];d=!0;var h=0,r,u,n,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z,H=null;if(0<s.length){var D=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||D,A=v;f.fillStyle=D;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var L=J(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var S=J(c,g.lineThickness);f.setLineDash(S)}for(var ea=!0;h<s.length;h++)if(n=s[h].x.getTime?
...
dataSeriesIndex:q,dataPointIndex:h,x1:r,y1:u};0!==s[h].markerSize&&(0<s[h].markerSize||0<g.markerSize)&&(n=g.getMarkerProperties(h,r,u,f),C.push(n),$=X($),w&&C.push({x:r,y:u,ctx:l,type:n.type,size:n.size,color:$,borderColor:$,borderThickness:n.borderThickness}));(s[h].indexLabel||g.indexLabel||s[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:s[h],dataSeries:g,point:{x:r,y:u},direction:0>s[h].y===a.axisY.reversed?1:-1,color:D})}b();W.drawMarkers(C)}}w&&
...
z=m.lineColor=m.options.lineColor||x,H=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=m.lineThickness;var D="solid";if(b.setLineDash){var A=J(m.nullDataLineDashType,m.lineThickness),D=m.lineDashType,B=J(D,m.lineThickness);b.setLineDash(B)}for(s=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!s)))if("number"!==typeof p[q].y)0<q&&!s&&(m.connectNullData?b.setLineDash&&(0<y.length&&(m.options.nullDataLineDashType||
!p[q-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,D=m.nullDataLineDashType):(d(),y=[])),s=!0;else{g=a.axisX.convertValueToPixel(g);s=a.axisY.convertValueToPixel(p[q].y);var L=m.dataPointIds[q];this._eventManager.objectMap[L]={id:L,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:s};y[y.length]={x:g,y:s};q<p.length-1&&(H!==(p[q].lineColor||z)||D!==(p[q].lineDashType||m.lineDashType))&&(H=p[q].lineColor||z,y[y.length-1].newStrokeStyle=H,b.setLineDash&&(p[q].lineDashType?(D=
...
a.dataSeriesIndexes[p],g=this.data[q],s=g.dataPoints,h=g.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=X(h);l.fillStyle=h;h=[];d=!0;var r=0,n,u,y,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z,H=null;c=!1;if(0<s.length){var D=g._colorSet[r%g._colorSet.length],v=g.lineColor=g.options.lineColor||D,A=v;f.fillStyle=D;f.strokeStyle=v;f.lineWidth=g.lineThickness;var L="solid";if(f.setLineDash){var S=J(g.nullDataLineDashType,g.lineThickness),
...
this._indexLabels.push({chartType:"stepArea",dataPoint:s[r],dataSeries:g,point:{x:n,y:u},direction:0>s[r].y===a.axisY.reversed?1:-1,color:D}))}b();W.drawMarkers(h)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ga.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;s=a.axisY.convertValueToPixel(p[f])}else s=a.axisY.convertValueToPixel(ga.y),s-=na;k.push({x:g,y:r-na});h[f]=r-s;y||$?(!y&&D.connectNullData?(b.setLineDash&&(D.options.nullDataLineDashType||x===D.lineDashType&&D.lineDashType!==D.nullDataLineDashType)&&(y=k.pop(),x=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(x),k.push(y),x=D.nullDataLineDashType,
b.setLineDash(S)),b.lineTo(g,s),w&&n.lineTo(g,s)):(b.beginPath(),b.moveTo(g,s),w&&(n.beginPath(),n.moveTo(g,s))),$=y=!1):(b.lineTo(g,s),w&&n.lineTo(g,s),0==q%250&&(d(),b.moveTo(g,s),w&&n.moveTo(g,s),k.push({x:g,y:r-na})));u={x:g,y:s};q<v.length-1&&(L!==(v[q].lineColor||A)||x!==(v[q].lineDashType||D.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,s),k.push({x:g,y:r-na}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(x=v[q].lineDashType,b.setLineDash(J(x,D.lineThickness))):(x=
D.lineDashType,b.setLineDash(B))));if(0<=D.dataPointIndexes[f]){var ka=D.dataPointIds[D.dataPointIndexes[f]];this._eventManager.objectMap[ka]={id:ka,objectType:"dataPoint",dataSeriesIndex:H,dataPointIndex:D.dataPointIndexes[f],x1:g,y1:s}}0<=D.dataPointIndexes[f]&&0!==ga.markerSize&&(0<ga.markerSize||0<D.markerSize)&&(na=D.getMarkerProperties(D.dataPointIndexes[f],g,s,b),l.push(na),f=X(ka),w&&l.push({x:g,y:s,ctx:n,type:na.type,size:na.size,color:f,borderColor:f,borderThickness:na.borderThickness}));
(ga.indexLabel||D.indexLabel||ga.indexLabelFormatter||D.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ga,dataSeries:D,point:{x:g,y:s},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,s);w&&n.moveTo(g,s)}delete D.dataPointIndexes}W.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
!$)))if("number"!==typeof ga.y)D.connectNullData||($||n)||d(),$=!0;else{var na;na=0!==a.dataPointYSums[f]?100*(ga.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ka=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=na+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;s=a.axisY.convertValueToPixel(p[f])}else s=a.axisY.convertValueToPixel(na),s-=ka;k.push({x:g,y:y-ka});h[f]=y-s;n||$?(!n&&D.connectNullData?(b.setLineDash&&(D.options.nullDataLineDashType||
u===D.lineDashType&&D.lineDashType!==D.nullDataLineDashType)&&(n=k.pop(),u=k[k.length-1],d(),b.moveTo(r.x,r.y),k.push(u),k.push(n),u=D.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,s),w&&x.lineTo(g,s)):(b.beginPath(),b.moveTo(g,s),w&&(x.beginPath(),x.moveTo(g,s))),$=n=!1):(b.lineTo(g,s),w&&x.lineTo(g,s),0==q%250&&(d(),b.moveTo(g,s),w&&x.moveTo(g,s),k.push({x:g,y:y-ka})));r={x:g,y:s};q<v.length-1&&(L!==(v[q].lineColor||A)||u!==(v[q].lineDashType||D.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,
...
"number"===typeof y[t].y[1]&&"number"===typeof y[t].y[2]&&"number"===typeof y[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[t].y[0]);m=a.axisY.convertValueToPixel(y[t].y[1]);p=a.axisY.convertValueToPixel(y[t].y[2]);q=a.axisY.convertValueToPixel(y[t].y[3]);var z=h-s/2<<0,H=z+s<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[t].color?y[t].color:u._colorSet[0],D=Math.round(Math.max(1,0.15*s)),v=0===D%2?0:0.5,A=u.dataPointIds[t];this._eventManager.objectMap[A]=
...
p=a.axisY.convertValueToPixel(x[l].y[3]);q=a.axisY.convertValueToPixel(x[l].y[4]);var v=t-s/2<<0,D=t+s/2<<0,e=x[l].color?x[l].color:y._colorSet[0],A=Math.round(Math.max(1,0.15*s)),B=0===A%2?0:0.5,L=x[l].whiskerColor?x[l].whiskerColor:x[l].color?y.whiskerColor?y.whiskerColor:x[l].color:y.whiskerColor?y.whiskerColor:e,S="number"===typeof x[l].whiskerThickness?x[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:A,ea=x[l].whiskerDashType?x[l].whiskerDashType:y.whiskerDashType,
...
v;b.lineWidth=m.lineThickness;var D="solid";if(b.setLineDash){var B=J(m.nullDataLineDashType,m.lineThickness),D=m.lineDashType,E=J(D,m.lineThickness);b.setLineDash(E)}for(var L=!0;g<p.length;g++)if(u=p[g].x.getTime?p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!L)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){s=a.axisX.convertValueToPixel(u);r=a.axisY.convertValueToPixel(p[g].y[0]);n=a.axisY.convertValueToPixel(p[g].y[1]);
q||L?(m.connectNullData&&!q?(b.setLineDash&&(m.options.nullDataLineDashType||D===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,D=m.nullDataLineDashType,b.setLineDash(B)),b.lineTo(s,r),w&&e.lineTo(s,r),h.push({x:s,y1:r,y2:n})):(b.beginPath(),b.moveTo(s,r),y={x:s,y:r},h=[],h.push({x:s,y1:r,y2:n}),w&&(e.beginPath(),e.moveTo(s,r))),L=q=!1):(b.lineTo(s,r),h.push({x:s,y1:r,y2:n}),w&&e.lineTo(s,r),0==g%250&&d());u=m.dataPointIds[g];this._eventManager.objectMap[u]=
{id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:s,y1:r,y2:n};g<p.length-1&&(A!==(p[g].lineColor||v)||D!==(p[g].lineDashType||m.lineDashType))&&(d(),A=p[g].lineColor||v,h[h.length-1].newStrokeStyle=A,b.strokeStyle=A,b.setLineDash&&(p[g].lineDashType?(D=p[g].lineDashType,h[h.length-1].newLineDashArray=J(D,m.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(D=m.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||
...
dataPoint:m[p],dataSeries:k,indexKeyword:1,point:{x:q,y:s},direction:m[p].y[0]<=m[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<n.length&&(k.options.nullDataLineDashType||!m[p-1].lineDashType))&&(n[n.length-1].newLineDashArray=D,z=k.nullDataLineDashType):(d(A,y),n=[],ba=[])),g=!0;d(A,y);W.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,
...
var u="number"===typeof n.options.lineThickness?Math.round(n.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var x=5<q&&n.bevelEnabled?!0:!1,z=!1,A=null,D=null,l=0;l<v.length;l++)if(v[l].getTime?m=v[l].x.getTime():m=v[l].x,"number"!==typeof v[l].y){if(0<l&&!z&&n.connectNullData)var B=n.options.nullDataLineDashType||!v[l-1].lineDashType?n.nullDataLineDashType:v[l-1].lineDashType;z=!0}else{h=a.axisX.convertValueToPixel(m);r=0===n.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(n.dataPointEOs[l].cumulativeSum);
...
(z&&c.setLineDash&&c.setLineDash(J(B,u)),c.beginPath(),c.moveTo(A,D-y),c.lineTo(L,S-y),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(A,D-y),b.lineTo(L,S-y),0<u&&b.stroke()));z=!1;A=E;D=0<v[l].y?r:k;L=v[l].lineDashType?v[l].lineDashType:n.options.lineDashType?n.options.lineDashType:"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:n.options.lineColor?n.options.lineColor:"#9e9e9e";c.lineWidth=u;c.setLineDash&&(L=J(L,u),c.setLineDash(L));(v[l].indexLabel||n.indexLabel||v[l].indexLabelFormatter||n.indexLabelFormatter)&&
...
h;h.center={x:x.x,y:x.y};h.y=f.y;h.radius=D;h.percentInnerRadius=E;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;h.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%k._colorSet.length];h.indexLabelLineThickness=r(f.indexLabelLineThickness)?k.indexLabelLineThickness:f.indexLabelLineThickness;h.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:k.indexLabelLineDashType;
...
c?(h="right"===p.hemisphere?t:q,k=c,null!==h&&(t=-c,c=p.indexLabelTextBlock.y-p.indexLabelTextBlock.height/2-(g[h].indexLabelTextBlock.y+g[h].indexLabelTextBlock.height/2),c-t<s&&(l=-t,h=f(h,l,d+1),+h.toFixed(y)>+l.toFixed(y)&&(k=c>s?-(c-s):-(t-(h-l)))))):0<c&&(h="right"===p.hemisphere?q:t,k=c,null!==h&&(t=c,c=g[h].indexLabelTextBlock.y-g[h].indexLabelTextBlock.height/2-(p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2),c-t<s&&(l=t,h=f(h,l,d+1),+h.toFixed(y)<+l.toFixed(y)&&(k=c>s?c-s:t-(l-h)))));
...
h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>u+p||n>C+p||s<r-p?!1:!0}q?(0>a&&(a=l),k!==a&&(c=k,d+=-z),0===l%Math.max(m.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(G(d,a,c),c=a=-1,d=0)}}0<d&&G(d,a,c)})()}}function h(){n.plotArea.layoutManager.reset();n.title&&(n.title.dockInsidePlotArea||"center"===n.title.horizontalAlign&&"center"===n.title.verticalAlign)&&n.title.render();if(n.subtitles)for(var a=0;a<n.subtitles.length;a++){var b=
...
null!==k.innerRadius?Ta(k.innerRadius,D):0.7*D;k.radius=D;"doughnut"===k.type&&(k.innerRadius=B);var E=Math.min(B/D,(D-1)/D);this.pieDoughnutClickHandler=function(a){n.isAnimating||!r(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&n._animator.animate(0,500,function(a){c(a);h();n.dispatchEvent("dataAnimationIterationEnd",{chart:n});n.dispatchEvent("dataAnimationEnd",{chart:n})}))};d();l();l();l();l();this.disableToolTip=
...
(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[k].textBlock.y=c-I[k].height/2,u.reversed?(I[k].textBlock.y+I[k].height>U+z&&(I[k].textBlock.y=U+z-I[k].height),I[k].textBlock.y<ta-z&&(I[k].textBlock.y=ta-z)):(I[k].textBlock.y<U-z&&(I[k].textBlock.y=U-z),I[k].textBlock.y+I[k].height>ta+z&&(I[k].textBlock.y=ta+z-I[k].height))}function f(){var a,b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<R.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=R[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/
...
y2:G[F],x3:B[F+1],y3:G[F+1],x4:a[F+1],y4:G[F+1],id:F,height:G[F+1]-G[F],color:Y});var da=2,I=[],ha=!1,Z=[],ia=[],S=!1;a=a=0;Ea(Z);for(F=0;F<y.length;F++)y[F].exploded&&(S=!0,u.reversed?Z.push(y.length-1-F):Z.push(F));P.clearRect(x.x1,x.y1,x.width,x.height);P.fillStyle=A.backgroundColor;P.fillRect(x.x1,x.y1,x.width,x.height);if(L&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(F=0;F<y.length;F++)I[F].isDirty||(a=I[F].textBlock.x+I[F].width,a=(K-a)/2,0==F&&(D=a),D>a&&(D=a));for(F=
0;F<R.length;F++)R[F].x1+=D,R[F].x2+=D,R[F].x3+=D,R[F].x4+=D,R[F].x5&&(R[F].x5+=D,R[F].x6+=D),I[F].textBlock.x+=D}for(F=0;F<R.length;F++)D=R[F],ra(P,D,u.fillOpacity),ia.push(D.y1);v(P);L&&u.visible&&("inside"===u.indexLabelPlacement||A.animationEnabled||m(P),A.animationEnabled||s());if(!L)for(F=0;F<y.length;F++)D=u.dataPointIds[F],a={id:D,objectType:"dataPoint",dataPointIndex:F,dataSeriesIndex:0,funnelSection:R[u.reversed?y.length-1-F:F]},A._eventManager.objectMap[D]=a;!A.animationEnabled&&S?n(A,
...
this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,u=s+0.15*this.lineHeight,v=0.7*this.lineHeight,x=v+0.02*this.lineHeight;this.ctx.moveTo(w,u);this.ctx.lineTo(w+v,u);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+v/2,u);this.ctx.lineTo(w+v/2,u+x);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w,u+x);this.ctx.lineTo(w+v,u+x);this.ctx.stroke();this.errorMarkerColor.shift()}W.drawMarker(g+f/2,s+this.lineHeight/2,this.ctx,q.markerType,"error"===
...
q[g].scaleBreaks&&q[g].scaleBreaks._appliedBreaks.length)for(var s=q[g].scaleBreaks._appliedBreaks,w=0;w<s.length&&!(s[w].startValue>q[g].viewportMaximum);w++)s[w].endValue<q[g].viewportMinimum||(r(q[g].scaleBreaks.firstBreakIndex)&&(q[g].scaleBreaks.firstBreakIndex=w),s[w].startValue>=q[g].viewPortMinimum&&(q[g].scaleBreaks.lastBreakIndex=w));for(var v=w=0,u=0,y=0,x=0,z=0,A=0,D,B,E=h=0,G,J,K,s=G=J=K=!1,g=0;g<q.length;g++)q[g]&&q[g].title&&(q[g]._titleTextBlock=new ja(q[g].ctx,{text:q[g].title,horizontalAlign:"center",
...
(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||r(D)||r(B)||m.isNavigator||m.stockChart)||(h=0,0<a[g].labelAngle?B+u>n&&(h+=0<a[g].labelAngle?B+u-n-aa:0):0>a[g].labelAngle?D-v<l&&D-v<a[g].viewportMinimum&&(E=l-(N+a[g].tickLength+z+D-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(B+u>n&&(h=B+u/2-n-aa),D-v<l&&D-v<a[g].viewportMinimum&&(E=l-N-a[g].tickLength-z-D+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===
a[g].minimum&&0<a[g].labelAngle&&0<h?n-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?l+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(l+=E),0<h&&(n-=h))),m.panEnabled?W=r(m.sessionVariables.axisX.height)?m.sessionVariables.axisX.height=W:m.sessionVariables.axisX.height:m.sessionVariables.axisX.height=W,h=Math.round(f.y2-W-e+F),k=Math.round(f.y2),a[g].lineCoordinates.x2=n,a[g].lineCoordinates.width=
...
a[g].bounds.y1),F+=y[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+R+N),d[g].lineCoordinates.x2=Math.round(f.x2-aa-Z>m.width-p?m.width-p:f.x2-aa-Z),d[g].lineCoordinates.width=Math.abs(n-l),d[g]._labels&&1<d[g]._labels.length&&(k=d[g]._labels[1],h="dateTime"===d[g].valueType?d[g]._labels[d[g]._labels.length-2]:d[g]._labels[d[g]._labels.length-1],v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/
2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),u=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),m.panEnabled?Y=r(m.sessionVariables.axisX2.height)?m.sessionVariables.axisX2.height=Y:m.sessionVariables.axisX2.height:m.sessionVariables.axisX2.height=Y,h=Math.round(f.y1),k=d[g].lineCoordinates.y1=h+Y+V-X,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=
d[g-1].lineCoordinates.y1-X-(d[g].labelEffectiveHeight||0)),"inside"===d[g].tickPlacement&&0<g&&(d[g].lineCoordinates.y1-=d[g].tickLength),d[g].bounds={x1:l,y1:h+(Y+V-x[g]-X),x2:n,y2:k,width:n-l},d[g].bounds.height=d[g].bounds.y2-d[g].bounds.y1,X+=x[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)N=m.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+
Y+V<Math.max(N,p)?Math.max(N,p):f.y1+Y+V),n=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/2:p,k=Math.round(f.y2-W-e-N),c[g].lineCoordinates={x1:l-T,y1:h,x2:n-T,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g-1].lineCoordinates.x1-T-(c[g].labelEffectiveWidth||0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),"inside"===c[g].tickPlacement&&
...
n=Math.round(l),N=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+Y+V<Math.max(N,p)?Math.max(N,p):f.y1+Y+V),N=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(W+e+N)),b[g].lineCoordinates={x1:l+U,y1:h,x2:l+U,y2:k,height:Math.abs(k-h)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g-1].lineCoordinates.x2+U+(b[g].labelEffectiveWidth||0),b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+
...
(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)s=M[w-1][g]===M[w][g]?!0:!1;else s=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)G=Q[w-1][g]===Q[w][g]?!0:!1;else G=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=O[w-1][g]===O[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=P[w-1][g]===P[w][g]?!0:!1;else K=!0}if(s&&G&&J&&K)break;w++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
m.width-10:f.x2-W-V),c[g].labelAutoFit&&!r(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(n=0<c[g].labelAngle?n-x/2:0===c[g].labelAngle?n-x/2:n)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=n,c[g].lineCoordinates.width=Math.abs(n-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates=
{},l=Math.round(f.x1+U+e),n=Math.round(f.x2-W-V>b[g].chart.width-10?b[g].chart.width-10:f.x2-W-V),b[g]&&b[g].labelAutoFit&&!r(z)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,z):0===b[g].labelAngle?Math.max(l,z/2):l),0<!d.length&&(n-=A/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=n,b[g].lineCoordinates.width=Math.abs(n-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=
...
(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),A=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));if(m.panEnabled)for(g=0;g<c.length;g++)p[g]=r(m.sessionVariables.axisY.height)?m.sessionVariables.axisY.height=p[g]:m.sessionVariables.axisY.height;else for(g=0;g<c.length;g++)m.sessionVariables.axisY.height=p[g];if(c&&0<c.length)for(g=c.length-
1;0<=g;g--)h=Math.round(f.y2),k=Math.round(f.y2>c[g].chart.height?c[g].chart.height:f.y2),c[g].lineCoordinates.y1=h-(p[g]+c[g].margin+Y),c[g].lineCoordinates.y2=h-(p[g]+c[g].margin+Y),"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.y1=c[g].lineCoordinates.y1+p[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)-c[g].tickLength-(c[g].stripLineLabelEffectiveHeight||0)-5,c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),"inside"===c[g].tickPlacement&&0<g&&(c[g].lineCoordinates.y1+=
c[g].tickLength,c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:l,y1:h-(p[g]+Y+c[g].margin),x2:n,y2:k-(Y+c[g].margin),width:n-l,height:p[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),Y+=p[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(h=Math.round(f.y1),k=Math.round(f.y1+(D[g]+b[g].margin+F)),b[g].lineCoordinates.y1=k,b[g].lineCoordinates.y2=
k,"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.y1=k-D[g]+(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)+b[g].tickLength+(b[g].stripLineLabelEffectiveHeight||0),b[g].lineCoordinates.y2=b[g].lineCoordinates.y1-b[g].lineThickness/2),"inside"===b[g].tickPlacement&&0<g&&(b[g].lineCoordinates.y1-=b[g].tickLength,b[g].lineCoordinates.y2=b[g].lineCoordinates.y1-b[g].lineThickness/2),b[g].bounds={x1:l,y1:h+(b[g].margin+F),x2:n,y2:k,width:n-l},b[g].bounds.height=b[g].bounds.y2-b[g].bounds.y1,
b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width),F+=D[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++){N=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(N,10)?Math.max(N,10):f.y1):f.y1<Math.max(N,10)?Math.max(N,10):f.y1;n=Math.round(f.x1+U+e);k=c&&0<c.length?Math.round(c[0]?
c[0].lineCoordinates.y1:f.y2-T>m.height-Math.max(N,10)?m.height-Math.max(N,10):f.y2-T):f.y2>m.height-Math.max(N,10)?m.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(n=0>c[N].labelAngle?Math.max(n,y):0===c[N].labelAngle?Math.max(n,y/2):n,l=0>c[N].labelAngle||0===c[N].labelAngle?n-U:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&b[N].labelAutoFit&&(n=b[N].lineCoordinates.x1,l=n-U);a[g].lineCoordinates={x1:n-O,y1:h,x2:n-O,y2:k,height:Math.abs(k-h)};"inside"===
a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(E[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+a[g].tickLength+(a[g].stripLineLabelEffectiveWidth||0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);"inside"===a[g].tickPlacement&&0<g&&(a[g].lineCoordinates.x1-=a[g].tickLength,a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:n-(E[g]+O),y1:h,x2:n-O,y2:k,height:k-h};a[g].bounds.width=a[g].bounds.x2-a[g].bounds.x1;
a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();O+=E[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){N=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(N,10)?Math.max(N,10):f.y1):f.y1<
Math.max(N,10)?Math.max(N,10):f.y1;n=Math.round(f.x2-W-V);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>m.height-Math.max(N,10)?m.height-Math.max(N,10):f.y2-T):f.y2>m.height-Math.max(N,10)?m.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(n=0>c[N].labelAngle?Math.max(n,y):0===c[N].labelAngle?Math.max(n,y/2):n,l=0>c[N].labelAngle||0===c[N].labelAngle?n-W:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&b[N].labelAutoFit&&(n=b[N].lineCoordinates.x2,
...
if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)s=M[w-1][g]===M[w][g]?!0:!1;else s=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)G=Q[w-1][g]===Q[w][g]?!0:!1;else G=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=B[w-1][g]===B[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=u[w-1][g]===u[w][g]?!0:!1;else K=!0}if(s&&G&&J&&K)break;w++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),
...
c),this.logarithmic&&(d[f].size=Math.pow(this.logarithmBase,d[f].size))};A.prototype.calculateBreaksInPixels=function(){if(!(this.scaleBreaks&&0>=this.scaleBreaks._appliedBreaks.length)){var a=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];a.length&&(this.scaleBreaks.firstBreakIndex=this.scaleBreaks.lastBreakIndex=null);for(var d=0;d<a.length&&!(a[d].startValue>this.conversionParameters.maximum);d++)a[d].endValue<this.conversionParameters.minimum||(r(this.scaleBreaks.firstBreakIndex)&&(this.scaleBreaks.firstBreakIndex=
...
r(k.startValue)?a.x-=c.textBlock.height-c.textBlock.fontSize/2+k.thickness/2:a.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=90,r(k.startValue)?a.x+=c.textBlock.height-c.textBlock.fontSize/2+k.thickness/2:a.x+=c.textBlock.height/2-c.textBlock.fontSize/2),a.y=-90===c.textBlock.angle?"near"===c.stripLine.labelAlign?this.chart.plotArea.y2-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1+c.textBlock.width)/2:this.chart.plotArea.y1+c.textBlock.width+
3:"near"===c.stripLine.labelAlign?this.chart.plotArea.y2-c.textBlock.width-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1-c.textBlock.width)/2:this.chart.plotArea.y1+3):"top"===this._position?(c.textBlock.maxWidth=this.options.stripLines[b].labelMaxWidth?this.options.stripLines[b].labelMaxWidth:this.chart.plotArea.height-3,c.textBlock.measureText(),a.x-c.textBlock.height-k.thickness/2>this.chart.plotArea.x1?r(k.startValue)?a.x-=c.textBlock.height-c.textBlock.fontSize/
2+k.thickness/2:a.x-=c.textBlock.height/2-c.textBlock.fontSize/2:(c.textBlock.angle=90,r(k.startValue)?a.x+=c.textBlock.height-c.textBlock.fontSize/2+k.thickness/2:a.x+=c.textBlock.height/2-c.textBlock.fontSize/2),a.y=-90===c.textBlock.angle?"near"===c.stripLine.labelAlign?this.chart.plotArea.y1+c.textBlock.width+3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1+c.textBlock.width)/2:this.chart.plotArea.y2-3:"near"===c.stripLine.labelAlign?this.chart.plotArea.y1+3:
"center"===c.stripLine.labelAlign?(this.chart.plotArea.y2+this.chart.plotArea.y1-c.textBlock.width)/2:this.chart.plotArea.y2-c.textBlock.width-3):"left"===this._position?(c.textBlock.maxWidth=this.options.stripLines[b].labelMaxWidth?this.options.stripLines[b].labelMaxWidth:this.chart.plotArea.width-3,c.textBlock.angle=0,c.textBlock.measureText(),a.y-c.textBlock.height-k.thickness/2>this.chart.plotArea.y1?r(k.startValue)?a.y-=c.textBlock.height-c.textBlock.fontSize/2+k.thickness/2:a.y-=c.textBlock.height/
2-c.textBlock.fontSize/2:r(k.startValue)?a.y+=c.textBlock.height-c.textBlock.fontSize/2+k.thickness/2:a.y+=c.textBlock.height/2-c.textBlock.fontSize+3,a.x="near"===c.stripLine.labelAlign?this.chart.plotArea.x1+3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.x2+this.chart.plotArea.x1)/2-c.textBlock.width/2:this.chart.plotArea.x2-c.textBlock.width-3):"right"===this._position&&(c.textBlock.maxWidth=this.options.stripLines[b].labelMaxWidth?this.options.stripLines[b].labelMaxWidth:this.chart.plotArea.width-
3,c.textBlock.angle=0,c.textBlock.measureText(),a.y-c.textBlock.height-k.thickness/2>this.chart.plotArea.y1?r(k.startValue)?a.y-=c.textBlock.height-c.textBlock.fontSize/2+k.thickness/2:a.y-=c.textBlock.height/2-c.textBlock.fontSize/2:r(k.startValue)?a.y+=c.textBlock.height-c.textBlock.fontSize/2+k.thickness/2:a.y-=c.textBlock.height/2-c.textBlock.fontSize/2+3,a.x="near"===c.stripLine.labelAlign?this.chart.plotArea.x2-c.textBlock.width-3:"center"===c.stripLine.labelAlign?(this.chart.plotArea.x2+this.chart.plotArea.x1)/
...
this.crosshair.render(a,d)};A.prototype.showCrosshair=function(a){r(a)||(a<this.viewportMinimum||a>this.viewportMaximum)||("top"===this._position||"bottom"===this._position?this.crosshair.render(this.convertValueToPixel(a),null,a):this.crosshair.render(null,this.convertValueToPixel(a),a))};A.prototype.renderGrid=function(){if(this.gridThickness&&0<this.gridThickness){var a=this.chart.ctx;a.save();var d,c=this.chart.plotArea;a.lineWidth=this.gridThickness;a.strokeStyle=this.gridColor;a.setLineDash&&
...
0.5<<0:this.conversionParameters.reference+this.conversionParameters.pixelPerUnit*(a-this.conversionParameters.minimum)+0.5};A.prototype.getApparentDifference=function(a,d,c,b){var e=this.scaleBreaks?this.scaleBreaks._appliedBreaks:[];if(this.logarithmic){c=r(c)?d/a:c;for(var f=0;f<e.length&&!(d<e[f].startValue);f++)a>e[f].endValue||(a<=e[f].startValue&&d>=e[f].endValue?c=c/e[f].endValue*e[f].startValue*e[f].size:a>=e[f].startValue&&d>=e[f].endValue?c=c/e[f].endValue*a*Math.pow(e[f].size,Math.log(e[f].endValue/
...
50),3),b,e,f,l;l=1;if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=this.minimum;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=this.maximum;if(this.scaleBreaks)for(l=0;l<this.scaleBreaks._appliedBreaks.length;l++)if((!r(this.sessionVariables.newViewportMinimum)&&this.sessionVariables.newViewportMinimum>=this.scaleBreaks._appliedBreaks[l].startValue||!r(this.options.minimum)&&this.options.minimum>=this.scaleBreaks._appliedBreaks[l].startValue||
!r(this.options.viewportMinimum)&&this.viewportMinimum>=this.scaleBreaks._appliedBreaks[l].startValue)&&(!r(this.sessionVariables.newViewportMaximum)&&this.sessionVariables.newViewportMaximum<=this.scaleBreaks._appliedBreaks[l].endValue||!r(this.options.maximum)&&this.options.maximum<=this.scaleBreaks._appliedBreaks[l].endValue||!r(this.options.viewportMaximum)&&this.viewportMaximum<=this.scaleBreaks._appliedBreaks[l].endValue)){this.scaleBreaks._appliedBreaks.splice(l,1);break}"axisX"===this.type?
...
"cross"===b&&(c.strokeStyle=f,c.lineWidth=e/4,c.beginPath(),c.moveTo(a-e/2,d-e/2),c.lineTo(a+e/2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return n}();B.version="v3.7.23 GA";window.CanvasJS&&(B&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=B)})();
